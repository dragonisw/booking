...
`;
  ...
  let o;
  i.contentWindow.document.head.querySelector(`style#windpress-variables`) ? o = i.contentWindow.document.head.querySelector(`style#windpress-variables`) : (o = i.contentWindow.document.createElement(`style`), o.id = `windpress-variables`, i.contentWindow.document.head.appendChild(o)), o && (o.textContent = a2);
}
