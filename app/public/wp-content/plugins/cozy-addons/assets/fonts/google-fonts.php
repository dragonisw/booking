...
/**
 * Returns an array of Google Fonts used by Cozy Addons.
 *
 * This function defines and returns a list of Google Fonts
 * that can be enqueued or used elsewhere in the theme or plugin.
 *
 * @return array List of Google Font names.
 */
function cozy_addons_google_fonts() {
	$fonts = array(
		'ABeeZee'                          => 'ABeeZee',
		'Abel'                             => 'Abel',
