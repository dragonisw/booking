        ...
        <?php if ($has_dates) : ?>
                    ...
                    <div class="space-y-4 flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3.5 text-sm md:text-base">
                            <div class="flex items-center gap-2">
                                <span class="text-slate-400 font-bold w-36 uppercase text-xs"><?php echo t('SỐ ĐIỆN THOẠI', 'PHONE NUMBER'); ?></span>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <strong class="text-[#d35400] font-bold"><?php echo $nights; ?> <?php echo t('đêm', 'night(s)'); ?></strong>
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-3xl shadow-2xl shadow-slate-200/50 p-6 md:p-12 border border-slate-100">
                <h3 class="text-xl md:text-2xl font-bold text-slate-900 mb-8 pb-4 border-b border-slate-100 uppercase tracking-tight">
                    <?php echo t('DANH SÁCH THÔNG TIN PHÒNG THEO NGÀY QUÝ KHÁCH CHỌN', 'LIST OF ROOMS AVAILABLE ON YOUR SELECTED DATES'); ?>
                </h3>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden group">
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4 py-3 border-y border-slate-100 text-sm">
                                    <div>
                                        <span class="text-slate-400 block text-xs"><?php echo t('Giá phòng/Đêm', 'Price/Night'); ?></span>
        ...
        <?php else : ?>
            ...
            <div class="bg-gradient-to-r from-orange-500 to-[#d35400] text-white rounded-[2rem] p-8 md:p-12 mb-12 shadow-xl shadow-orange-500/10 relative overflow-hidden">
                ...
                <div class="relative z-10 max-w-2xl space-y-4">
                    ...
                    <h2 class="text-3xl md:text-4xl font-bold tracking-tight leading-tight"><?php echo t('Tìm phòng nghỉ hoàn hảo cho kỳ nghỉ của bạn', 'Find the perfect room for your vacation'); ?></h2>
                    <p class="text-white/80 text-sm md:text-base"><?php echo t('Vui lòng nhập ngày nhận phòng và ngày trả phòng mong muốn để kiểm tra giá phòng chính xác nhất, tình trạng phòng trống và tiến hành đặt phòng nghỉ ngay lập tức.', 'Please enter your desired check-in and check-out dates to check the most accurate room rates, availability, and proceed to book a room immediately.'); ?></p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10" id="room-grid">
                    ...
                    <?php endwhile; else: ?>
                        <div class="col-span-1 md:col-span-2 lg:col-span-3 text-center py-24 bg-slate-50 rounded-[2rem] border-2 border-dashed border-slate-200">
                             ...
                             <p class="text-slate-500 max-w-sm mx-auto"><?php echo t('Chúng tôi hiện đang bổ sung thêm các lựa chọn phòng nghỉ mới. Vui lòng quay lại sớm!', 'We are currently adding new room options. Please check back soon!'); ?></p>
                             <div class="mt-8">
