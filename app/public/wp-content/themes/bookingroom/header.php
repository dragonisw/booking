...
<body <?php body_class(is_front_page() || is_home() || is_page_template('page-trang-chu.php') ? 'is-home-style' : ''); ?>>
    ...
    <header id="masthead" role="banner">
        ...
        <ul style="display:flex; list-style:none; margin:0; padding:0; gap:6px;">
            <li><a href="<?php echo esc_url(home_url('/vi/')); ?>" class="<?php echo (!defined('SITE_LANG') || SITE_LANG === 'vi' ? 'active' : ''); ?>">VI</a></li>
            <li class="sep">|</li>
            <li><a href="<?php echo esc_url(home_url('/eng/')); ?>" class="<?php echo (defined('SITE_LANG') && SITE_LANG === 'en' ? 'active' : ''); ?>">EN</a></li>
        </ul>
</div>
